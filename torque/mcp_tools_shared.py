...
from .mcp_scoped.proposals import (
    ...
    _proposal_context_anchor_count,
    ...
    _require_product_ack_anchor,
    _require_proposal_peer_anchor,
...
from .mcp_scoped.messaging import (
    ...
    _incoming_user_reply_candidate,
    _infer_architect_dispatch_task_id_from_message,
    _infer_architect_user_reply_to_id,
