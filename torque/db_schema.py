...
GROUP_PROVIDER_RUNTIME_COLUMNS = {
    ...
    "agent_fast_mode": "TEXT NOT NULL DEFAULT 'inherit'",
    ...
    "worker_fast_mode": "TEXT NOT NULL DEFAULT 'inherit'",
}
...
GROUP_OPERATIONAL_COLUMNS = {
    ...
    "architect_fast_mode": "TEXT NOT NULL DEFAULT 'inherit'",
...
ENGINEER_SETTINGS_COLUMNS = {
    ...
    "engineer_fast_mode": "TEXT NOT NULL DEFAULT 'inherit'",
