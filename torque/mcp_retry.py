...
_SCOPED_WRITE_SUFFIXES = {
    ...
    "decision_update",
    "decision_link",
    "product_task_propose",
    "product_decision_create",
    "product_decision_update",
    "product_decision_link",
    "product_idea_brief_create",
    "product_idea_brief_update",
    "product_idea_brief_refine",
    "product_idea_brief_park",
    "product_idea_brief_archive",
    "product_idea_brief_propose",
    "product_idea_brief_promote",
    "product_peer_message",
    "product_peer_reply",
    "product_message_user",
    "product_ask_user",
    "product_journal",
