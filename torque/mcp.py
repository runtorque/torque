...
from .server_review import _amend_review_verdict_evidence
...
TOOLS = [
    ...
    *help_tool_specs("torque_"),
    ...
    {
        "name": "torque_review_verdict_amend", "authority": {"requirements": [{"capability": "task.review.amend","minimum_scope": "self","target_argument": "task","target_kind": "task"}]},
        "description": (
