...
class WeaverPromptTests(unittest.TestCase):
    ...
    def test_prompt_includes_compact_operational_guidance_sections(self):
        ...
        self.assertIn("weaver_streams_list", prompt)
        self.assertIn("weaver_stream_show", prompt)
        self.assertIn("weaver_session_map", prompt)
        ...
        self.assertIn("inspect the action catalog with `weaver_actions_list`", prompt)
        ...
        self.assertIn("consult `weaver_actions_list`", prompt)
        self.assertIn("`weaver_action_show`", prompt)
        ...
        self.assertIn("weaver_journal_read → weaver_session_map → weaver_events", prompt)
