...
class ArchitectPromptTests(unittest.TestCase):
    ...
    def test_torque_steward_prompt_emphasizes_read_only_operations_boundary(self):
        ...
        self.assertIn("Steward authority is observation/recommendation plus", prompt)
        self.assertIn("architect_message_user", prompt)
        self.assertIn("architect_ask", prompt)
        self.assertIn("architect_journal", prompt)
        self.assertIn("architect_peer_message", prompt)
