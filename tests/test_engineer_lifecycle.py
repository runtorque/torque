...
class EngineerLifecycleTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_injected_engineer_to_architect_prompt_respects_ack_required(self):
        ...
        self.assertNotIn("mcp__torque__agent_reply", status_prompt)
        ...
        self.assertIn(
            'Reply with: mcp__torque__agent_reply(message_id="msg-question"',
            question_prompt,
        )
        ...
        self.assertIn(
            'Optional reply: mcp__torque__peer_reply(message_id="msg-peer-status"',
            peer_status_prompt,
        )
        ...
        self.assertIn(
            'Ack required. Reply with: mcp__torque__peer_reply(message_id="msg-peer-ack"',
            peer_ack_prompt,
        )
        ...
        self.assertIn(
            'Reply with: mcp__torque__agent_reply(message_id="msg-architect"',
            engineer_prompt,
        )
        ...
        self.assertIn(
            'Reply with: mcp__torque__peer_reply(message_id="msg-peer-engineer"',
            engineer_peer_prompt,
        )
        self.assertIn(
            'Inspect referenced context with: mcp__torque__peer_context(message_id="msg-peer-engineer"',
            engineer_peer_prompt,
        )
        self.assertNotIn("mcp__torque__agent_reply", engineer_peer_prompt)
    ...
    async def test_relaunch_stopped_architect_uses_engineer_launch_and_architect_mcp_entrypoint(self):
        ...
        self.assertEqual(architect.effective_agent_class_version, "5")
