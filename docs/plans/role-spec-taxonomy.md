...
| `runtime-pty` | Terminal/session runtime: iTerm2 bridge, standalone/supervised PTY, adapters, reconnect, boot timing, and provider send paths. | `pty`, `runtime`, `iTerm2`, `boot-doa`, reconnect/session resume, provider adapter issues |
