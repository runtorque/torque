...
9. For legacy Toolbelt migration work only, verify any already-installed Toolbelt daemon still presents the same state through `make open`; the Makefile no longer installs or updates the iTerm2 Scripts copy.
