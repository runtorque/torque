...
function _loadPanelApp(appName) {
  ...
  if (appName === 'templates') {
    if (typeof agentTemplateEnsureLoaded === 'function') {
...
function _reloadGroupScopedPanelApp(appName) {
  ...
  if (appName === 'templates') {
    if (typeof agentTemplateBeginGroupSwitch === 'function') {
...
function _restorePanelState() {
  ...
  if (typeof _detachedWindowActive === 'function' && _detachedWindowActive()) {
    ...
    if (detachedApp === 'mission-control' && typeof renderMissionControlPanel === 'function') renderMissionControlPanel();
  ...
  if (active) {
    ...
    if (active === 'mission-control' && typeof renderMissionControlPanel === 'function') renderMissionControlPanel();
