...
allowed-tools: mcp__loom__engineer_task_show, mcp__loom__loom_context
...
If $ARGUMENTS is empty, call loom_context to find the current agent's linked task, then call engineer_task_show with that task's slug.
